...
select * from participated;
insert into accident values(16,'2008-07-14','M.G Road');
insert into person values('A06','Rohit','Basavanaguddi');
insert into car values('KA018489','Santro', 2002);
insert into participated values('A06','KA018489',16,15000);
commit;
select * from accident;
select count(driver_id) from participated p,accident a where a.accident_date like '2008%' and p.report_num=a.report_num;
select count(*) from car c,participated p where c.reg_num=p.reg_num and c.model='Toyota';